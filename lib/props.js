...
const getReactPropName = propName =>
  has.call(reactProps, propName) // react prop name?
    ? reactProps[propName]
    : has.call(reactSyntheticEvents, propName) // react event name?
